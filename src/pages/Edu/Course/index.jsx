  ...
  render () {
    ...
    courseList = courseList.items.map((item, index) => {
      return {
        // 把原来数组展开
        ...item,
        // 再增加一个index属性 默认index从0开始 index是下标
        // 可是我们需要的序号 从1开始
        index: index + 1
      }
    })
    ...
    // total表示的是所有课程的数据
    // 而courseList地址指向已经不是this.props.courseList了
        ...
        <div className="course-table">
          ...
          <Table
            ...
            onChange={(pagination, filters, sorter, extra) => {
              // console.log('与sorter配合使用，完成后端排序')
